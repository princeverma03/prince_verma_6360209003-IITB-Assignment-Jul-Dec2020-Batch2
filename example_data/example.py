...
CURRENT_DIR = Path(os.path.abspath(os.path.dirname(__file__)))#'C:\Users\user\Desktop\Work\iit_DL\OCR\text_renderer-master\example_data\')))
...
rand_data = GeneratorCfg(
    ...
    render_cfg=RenderCfg(
        bg_dir=BG_DIR,
        perspective_transform=perspective_transform,
        corpus=RandCorpus(RandCorpusCfg(chars_file=CHAR_DIR / "eng.txt", **font_cfg),),
    ),
)
